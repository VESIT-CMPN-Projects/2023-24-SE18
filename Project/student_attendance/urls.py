...
urlpatterns = [
    ...
    path(
     ...
     path(
        "manage-class-wise-student-attendance-view-for-heads",
        student_attendance_views.attendance_view_class_wise_fn,
        name="manage_class_wise_student_attendance_view_for_heads",
    ),
    ...
    path('ajax/fetch-attendance-details/', student_attendance_views.ajax_fetch_attendance_details, name='ajax_fetch_attendance_details'), # AJAX
    path('ajax/load/students/from/class/',student_attendance_views.ajax_load_students_from_class, name='ajax_load_students_from_class'),
